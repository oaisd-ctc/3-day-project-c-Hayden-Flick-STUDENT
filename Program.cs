...
public class Program
{
    ...
    public static Player player2 = new Player("Rogue", 125, 3, 3, 1, 3, 5);
    public static Player player3 = new Player("Mage", 100, 1, 5, 1, 5, 4);
    public static Enemy enemy1 = new Enemy("Goblin", 75, 3, 1, 1, 1, 4);
